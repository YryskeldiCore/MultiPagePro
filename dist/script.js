...
/* harmony import */ var _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/slider/sliderMini */ "./src/js/modules/slider/sliderMini.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var sliderPage2 = new _modules_slider_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: ".moduleapp",
    triggers: ".next"
  });
  sliderPage2.render();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay').init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.module__video .play', '.overlay').init();
  var showUpSlider = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_2__["default"]({
    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var content = this.closest('.module__info-show').nextElementSibling;
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(parent, counter, items) {
    ...
    key: "hideElems",
    value: function hideElems(elems) {
    ...
    value: function maskNum() {
      ...
      inputs.forEach(function (input) {
        ...
        input.addEventListener('keyup', mask, function (e) {
          // if we move cursor with key its back to 4 pos 
          if (e.code === 'ArrowLeft') {
            e.preventDefault();
  ...
  _createClass(Video, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var playBtnActive = this.activeBtn.querySelector('svg').cloneNode(true);

        if (state.data === 0) {
          if (blockedElem.querySelector('.play__circle').classList.contains('closed')) {
            blockedElem.querySelector('.play__circle').classList.remove('closed');
            blockedElem.querySelector('svg').remove();
            blockedElem.querySelector('.play__circle').appendChild(playBtnActive);
...
function (_Slider) {
  ...
  function SliderMain(triggers) {
    _classCallCheck(this, SliderMain);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).call(this, triggers));
  }
  ...
  _createClass(SliderMain, [{
    ...
    value: function switchSlides() {
      ...
      document.querySelectorAll('.prevmodule').forEach(function (prevArr) {
...
function (_Slider) {
  ...
  function SliderMini(container, prev, next, activeClass, animate, auto) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, prev, next, activeClass, animate, auto));
  }
  ...
  _createClass(SliderMini, [{
    ...
    value: function nextSlide() {
      if (this.slides[0].tagName == "BUTTON" && this.slides[1].tagName == "BUTTON") {
        ...
        this.addActiveClass();
      } else if (this.slides[1].tagName == "BUTTON" && this.slides[2].tagName == "BUTTON") {
        this.container.appendChild(this.slides[1]);
        this.container.appendChild(this.slides[2]);
        this.container.appendChild(this.slides[3]);
        this.addActiveClass();
      } else if (this.slides[2].tagName == "BUTTON" && this.slides[3].tagName == "BUTTON") {
        this.container.appendChild(this.slides[2]);
        this.addActiveClass();
